  ...
  std::ostream & out)
{
  ...
  // member: successful_count
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.successful_count, out);
    out << ", ";
  }
  ...
  {
    out << "failed_count: ";
    rosidl_generator_traits::value_to_yaml(msg.failed_count, out);
    out << ", ";
  }

  // member: failed_indices
  {
    if (msg.failed_indices.size() == 0) {
      out << "failed_indices: []";
    } else {
      out << "failed_indices: [";
      size_t pending_items = msg.failed_indices.size();
      for (auto item : msg.failed_indices) {
