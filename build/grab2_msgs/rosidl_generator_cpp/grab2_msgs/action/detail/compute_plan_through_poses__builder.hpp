...
class Init_ComputePlanThroughPoses_Result_failed_indices
{
public:
  explicit Init_ComputePlanThroughPoses_Result_failed_indices(::grab2_msgs::action::ComputePlanThroughPoses_Result & msg)
  : msg_(msg)
  {}
  ::grab2_msgs::action::ComputePlanThroughPoses_Result failed_indices(::grab2_msgs::action::ComputePlanThroughPoses_Result::_failed_indices_type arg)
  {
    msg_.failed_indices = std::move(arg);
    return std::move(msg_);
  }
...
class Init_ComputePlanThroughPoses_Result_failed_count
{
public:
  explicit Init_ComputePlanThroughPoses_Result_failed_count(::grab2_msgs::action::ComputePlanThroughPoses_Result & msg)
  : msg_(msg)
  {}
  Init_ComputePlanThroughPoses_Result_failed_indices failed_count(::grab2_msgs::action::ComputePlanThroughPoses_Result::_failed_count_type arg)
  {
    msg_.failed_count = std::move(arg);
    return Init_ComputePlanThroughPoses_Result_failed_indices(msg_);
  }
...
class Init_ComputePlanThroughPoses_Result_successful_count
{
public:
  explicit Init_ComputePlanThroughPoses_Result_successful_count(::grab2_msgs::action::ComputePlanThroughPoses_Result & msg)
  : msg_(msg)
  {}
  Init_ComputePlanThroughPoses_Result_failed_count successful_count(::grab2_msgs::action::ComputePlanThroughPoses_Result::_successful_count_type arg)
  {
    msg_.successful_count = std::move(arg);
    return Init_ComputePlanThroughPoses_Result_failed_count(msg_);
  }
...
class Init_ComputePlanThroughPoses_Result_total_duration
{
public:
  explicit Init_ComputePlanThroughPoses_Result_total_duration(::grab2_msgs::action::ComputePlanThroughPoses_Result & msg)
  : msg_(msg)
  {}
  Init_ComputePlanThroughPoses_Result_successful_count total_duration(::grab2_msgs::action::ComputePlanThroughPoses_Result::_total_duration_type arg)
  {
    msg_.total_duration = std::move(arg);
    return Init_ComputePlanThroughPoses_Result_successful_count(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_ComputePlanThroughPoses_Result_total_duration error_string(::grab2_msgs::action::ComputePlanThroughPoses_Result::_error_string_type arg)
  {
    msg_.error_string = std::move(arg);
    return Init_ComputePlanThroughPoses_Result_total_duration(msg_);
  }
...
class Init_ComputePlanThroughPoses_Feedback_current_status
{
public:
  explicit Init_ComputePlanThroughPoses_Feedback_current_status(::grab2_msgs::action::ComputePlanThroughPoses_Feedback & msg)
  : msg_(msg)
  {}
  ::grab2_msgs::action::ComputePlanThroughPoses_Feedback current_status(::grab2_msgs::action::ComputePlanThroughPoses_Feedback::_current_status_type arg)
  {
...
private:
  ::grab2_msgs::action::ComputePlanThroughPoses_Feedback msg_;
};

class Init_ComputePlanThroughPoses_Feedback_progress_percentage
{
public:
  Init_ComputePlanThroughPoses_Feedback_progress_percentage()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ComputePlanThroughPoses_Feedback_current_status progress_percentage(::grab2_msgs::action::ComputePlanThroughPoses_Feedback::_progress_percentage_type arg)
  {
    msg_.progress_percentage = std::move(arg);
    return Init_ComputePlanThroughPoses_Feedback_current_status(msg_);
  }
...
{
  return grab2_msgs::action::builder::Init_ComputePlanThroughPoses_Feedback_progress_percentage();
}
