...
struct ComputePlanThroughPoses_Result_
{
  ...
  : trajectory(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->successful_count = 0l;
      this->failed_count = 0l;
    }
  }
  ...
  using _successful_count_type =
    int32_t;
  _successful_count_type successful_count;
  using _failed_count_type =
    int32_t;
  _failed_count_type failed_count;
  using _failed_indices_type =
    std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>>;
  _failed_indices_type failed_indices;
  ...
  Type & set__successful_count(
    const int32_t & _arg)
  {
    this->successful_count = _arg;
    return *this;
  }
  Type & set__failed_count(
    const int32_t & _arg)
  {
    this->failed_count = _arg;
    return *this;
  }
  Type & set__failed_indices(
    const std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> & _arg)
  {
    this->failed_indices = _arg;
    return *this;
  }
  ...
  bool operator==(const ComputePlanThroughPoses_Result_ & other) const
  {
    ...
    if (this->successful_count != other.successful_count) {
      return false;
    }
    if (this->failed_count != other.failed_count) {
      return false;
    }
    if (this->failed_indices != other.failed_indices) {
      return false;
    }
    return true;
  }
